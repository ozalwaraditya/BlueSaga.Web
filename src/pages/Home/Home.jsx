...
const Home = () => {
  ...
  const reviews = [
    ...
    },
    {
      name: "Michael Chen",
      rating: 5,
      text: "Best online shopping experience I've had. Great customer service!",
      avatar: "MC",
    },
    {
      name: "Emma Wilson",
      rating: 5,
      text: "Love the variety of products. Always find what I need here.",
      avatar: "EW",
    },
  ];
            ...
            {categories.map((cat, index) => (
              ...
              >
                ...
                >
                  ...
                  <p style={{ fontSize: "1rem", opacity: 0.9 }}>{cat.count}</p>
                </div>
              </div>
            ))}
          </div>
